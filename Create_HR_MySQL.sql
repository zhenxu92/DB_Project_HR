...
-- create user ruiyanghe identified by '123456';
-- GRANT ALL PRIVILEGES ON hr.* To ruiyanghe; 
-- GRANT ALL PRIVILEGES ON ap.* To ruiyanghe; 
-- GRANT ALL PRIVILEGES ON ex.* To ruiyanghe; 
-- GRANT ALL PRIVILEGES ON om.* To ruiyanghe; 
